...
namespace MProjectWeb.Models.Sqlite
{
    public partial class MProjectDeskSQLITEContext : DbContext
    {
        ...
        {
            options.UseSqlite(@"data source=C:\Users\admi\Desktop\Trabajo de grado\PROGRAMMING\CODE\MProjectDeskSQLITE");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<actividades>(entity =>
            {
                ...
                entity.HasOne(d => d.id_folderNavigation).WithMany(p => p.actividades).HasForeignKey(d => d.id_folder);
            });
            ...
            modelBuilder.Entity<archivos>(entity =>
            {
                ...
                entity.HasOne(d => d.id_folderNavigation).WithMany(p => p.archivos).HasForeignKey(d => d.id_folder).OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity<caracteristicas>(entity =>
            {
                ...
                entity.Property(e => e.tipo_duracion).HasColumnType("VARCHAR");

                entity.HasOne(d => d.id_actividadNavigation).WithMany(p => p.caracteristicas).HasForeignKey(d => d.id_actividad).OnDelete(DeleteBehavior.Restrict);

                entity.HasOne(d => d.id_proyectoNavigation).WithMany(p => p.caracteristicas).HasForeignKey(d => d.id_proyecto).OnDelete(DeleteBehavior.Restrict);
            ...
            {
                entity.HasKey(e => e.id_folder);

                entity.Property(e => e.nombre)
                    .IsRequired()
                    .HasColumnType("VARCHAR");

                entity.HasOne(d => d.Parent_id_folderNavigation).WithMany(p => p.InverseParent_id_folderNavigation).HasForeignKey(d => d.Parent_id_folder).OnDelete(DeleteBehavior.Restrict);

                entity.HasOne(d => d.id_proyectoNavigation).WithMany(p => p.folders).HasForeignKey(d => d.id_proyecto).OnDelete(DeleteBehavior.Restrict);
            });
            ...
            modelBuilder.Entity<usuarios_proyectos>(entity =>
            {
                entity.HasKey(e => new { e.id_usuario, e.id_proyecto });

                entity.HasOne(d => d.id_proyectoNavigation).WithMany(p => p.usuarios_proyectos).HasForeignKey(d => d.id_proyecto).OnDelete(DeleteBehavior.Restrict);

                entity.HasOne(d => d.id_usuarioNavigation).WithMany(p => p.usuarios_proyectos).HasForeignKey(d => d.id_usuario).OnDelete(DeleteBehavior.Restrict);
            });
        }
